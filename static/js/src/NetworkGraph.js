    ...
    function renderGraph(container, data) {
        ...
        nodeEls.forEach(function (ne) {
            ne.el.addEventListener('mouseenter', function (evt) {
                ...
                tooltip.innerHTML = '<b>' + ne.data.id + '</b><br>' +
                    'Degree: ' + (ne.data.degree * 100).toFixed(0) + '%<br>' +
                    'Betweenness: ' + ne.data.betweenness.toFixed(3) + '<br>' +
                    'Closeness: ' + ne.data.closeness.toFixed(3);
        ...
        function resetSelection() {
            nodeEls.forEach(function (ne) { ne.el.style.opacity = '1'; });
            edgeEls.forEach(function (ee) { ee.el.style.opacity = '0.8'; });
        }
        ...
        setTimeout(function () { svg.style.opacity = '1'; }, 50);
